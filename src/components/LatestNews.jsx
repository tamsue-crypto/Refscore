...
export default function LatestNews({context}) {
    let filteredArticles = articles.filter(article => article.tag != 'Opinião' && article.tag != 'Análise').sort((a, b) => b._id - a._id).slice(0, 2);
            ...
            <div className='news-area'>
                ...
                <div className='news-container flex'>
                    {filteredArticles.map((article) =>
                        <div className='news' key={article.id}>
